    ...
    Column(modifier = Modifier.padding(16.dp)) {
        ...
        OutlinedTextField(
            ...
            colors = OutlinedTextFieldDefaults.colors(
                ...
                unfocusedBorderColor = MaterialTheme.colorScheme.onBackground, // Border color when unfocused
        ...
        for (i in 0..6) {
            ...
            Row {
                Checkbox(checked = individualCheck, colors = CheckboxDefaults.colors(
        ...
        Row {
            ...
            Switch(
                ...
                onCheckedChange = { recurringValue = it },
